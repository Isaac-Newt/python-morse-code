...
class MainWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.set_default_size(325, 150)
        self.main_area = Gtk.Grid(orientation=Gtk.Orientation.VERTICAL)
    ...
    def build_main_view(self):
        ...
        self.letters_to_morse.add(output_box)

        self.main_area.add(self.letters_to_morse)
